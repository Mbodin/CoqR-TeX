...
consider that \mintinline{C}{cr} is a sequence of newlines,
as shown below.
\begin{minted}{OCaml}
cr:
  | NEW_LINE cr { }
...
the lexer and parser both shared a global variable \mintinline{OCaml}{eatlines : bool ref}.
...
but Bison is not).
For instance, the empty block \mintinline{R}|{}|
