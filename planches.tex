...
\begin{center}
    \begin{tikzpicture}
    \node [box] (C) {\Cn{} code} ;
    \node [box, right = 3cm of C] (low) {\parbox{23mm}{\centering{}\Coq{} formalisation}} ;

    \draw [DarkPlum, <->, thick] (low) to node [above] {Eyeball} node [below] {correspondance} (C) ;
\end{tikzpicture}
\end{center}
    \begin{itemize}
        ...
        \only<2>{
            ...
            \begin{block}{Content of the core}
                \begin{itemize}
                    ...
                    \item Function calls;
                    \item Environments, delayed evaluation (closures);
                    \item TODO
                \end{itemize}
            \end{block}
        }
