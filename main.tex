...
\newtext{Various models of C's heap~\parencite{formalin,Leroy-Compcert-CACM} exist in Coq, but in \CoqR{} we exploit the specific structure around which GNU~R is built:} almost all objects manipulated by GNU~R
