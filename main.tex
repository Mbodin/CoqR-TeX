...
\todo{Initialization of R, global variables.}

At a closer look, we tried to structure the project
to make it as maintainable as possible.
%
\todo{The [runs] trick to support looping in Coq in a structured way (similar to JSRef).}
