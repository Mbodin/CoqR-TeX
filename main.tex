...
the corresponding elements of the array \mintinline{R}{a} in order.
But if \mintinline{R}{i} evaluates to an array of negative integers,
then the array \mintinline{R}{a} is copied,
and all the elements whose (opposite) index is in the array \mintinline{R}{i}
are removed.
...
As \R{} is untyped,
the function \mintinline{R}{function (a, i) a[i]}
...
In its second call, the variable \mintinline{R}{b}
has not been defined because the assignment \mintinline{R}{b <- 1}
was not evaluated.
\begin{minted}{R}
