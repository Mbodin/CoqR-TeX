...
(corresponding to the Coq constructors
...
In total,
our testing framework categorizes each step of computation
in one of 7 classes:
as either ``pass'', ``fail'', ``not-implemented'',
...
%
Section~\ref{sec:library:development} shows how this framework
also drive the development process forwards.
...
The results of our tool are available at \url{coqr.dcc.uchile.cl}.\mbi{
...
Our testing framework categorized a large number of bugs
...
We added several new result interpreters in our framework
to cover more types.
...
functions are being used at lot in our test suites,
