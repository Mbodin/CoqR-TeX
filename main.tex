...
\renewcommand*{\bibfont}{\small} % We are allowed to set the font size of the bibliography to anything between 8pt (\footnotesize) to 10pt (\normalsize).
...
\affiliation{
  ...
  % \postcode{Post-Code2a}
  % \country{Chile}
  \titlenote{T. D{\'i}az and {\'E.} Tanter are partially funded by the Millenium Institute for Foundational Research on Data (IMFD Chile)}
}
