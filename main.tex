...
The formalization is a big-step operational semantics, in the form of an interpreter.
...
or a \mintinline{Coq}{NilSxp}-element.
...
No constraint is given to the first element \mintinline{Coq}{car} of the list:
lists are untyped in R and can hold various kinds of elements.
%
...
Indeed, reaching one of these results means that the result is out of scope for our interpreter.
This is the reason why these were not considered harmful
...
only the success case is left, the other kinds of results being propagated.
...
but it can be extremely cumbersome to manually perform this transition
