...
\newtext{%
\CoqR{} nevertheless shares several design ideas from JSCert.
...
a similar tool for R seems implementable.}
...
deep-embeddings are notorously hard to reason about in proof assistants.
We instead defined \CoqR{} as a shallow-embedding,
which we have shown in Section~\ref{sec:proofs} to be suitable to build proofs about R and R programs.}
%
