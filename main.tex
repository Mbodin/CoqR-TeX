...
as deep-embeddings are notorously hard to reason about in proof assistants.
We instead defined \CoqR{} as a shallow-embedding,
and we have shown in Section~\ref{sec:proofs} that it is suitable for building proofs about R and R programs.}
%
