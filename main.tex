...
The \mintinline{C}{SEXP} type is an alias for \mintinline{C}{EXP*},
that is, pointers to basic language elements.
...
%
The initialization of global variable is fairly subtle. Most initializations perform local computations, calling nucleus functions.
