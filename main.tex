...
\eti{need to restructure this section, separate the part on "dealing with globals" from the "core/extension" aspect}
...
This is larger than in the JSCert project.\et{ref + how large is JSCert?}
...
our formalization effort on a very restricted part of the language
in a first stage,
