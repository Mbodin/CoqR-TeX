...
\newtext{JSCert served as the basis for the JSExplain tool~\parencite{JSExplain},
aiming to explain JavaScript to non-specialists.
As \CoqR{} uses a similar monadic structure,
it is possible to build a similar tool for R.}
...
making our shallow-embedding more suitable.}
%
