...
\newtext{This is longer by several orders of magnitude than GNU~R's execution time.
We do not consider this as an issue:
we aim to provide a faithfull formalization of the behavior of the R language,
and not to provide an alternative R interpreter.}
