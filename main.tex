...
Some of these change the structures described by the invariants,
...
and some invariants proofs not being automatically discharged by the \mintinline{Coq}{computeR} tactic---%
...
This is a rather complex proof to build.
