...
\begin{frame}[fragile]
    ...
    \hfill\parbox[t][1em][t]{10mm}{\includegraphics[width = 10mm]{images/CoqLogo.png}}}
...
\begin{innertikz}[overlay, remember picture]
  \def\distshift{17mm} % WTF: This looks like a TikZ bug: nodes appear this distance below their supposed location…
    ...
    \node<2> [above = 2cm of evalRellipse, DarkScarletRed] (thistalk) {This talk} ;
    \draw<2> [thick, DarkScarletRed, ->] (thistalk) to [bend right = 50] (evalRellipse.170) ;
