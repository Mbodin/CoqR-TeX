...
(see Section~\ref{sec:monadic:style}).
I could have added an argument to store \mintinline{C}{R_FunTab}
in the \mintinline{Coq}{runs} structure,
...
In particular,
the file \texttt{low/Reval.v} ends with a definition of \mintinline{Coq}{runs} using fuel,
and \texttt{low/Rfeatures.v} with a definition of \mintinline{Coq}{R_FunTab} using fuel.
...
cond: '(' expr ')'      { $$ = xxcond($2); }
    ;
\end{minted}
%$$% Sorry, my syntax coloring doesn’t like this $$…
